  ...
  <div class="wrap">
	<div class="header">
		<div class="headertop_desc">
			<div class="call">
				 <p><span>Need help?</span> call us <span class="number">(0253) 6066040</span></span></p>
			</div>
    ...
    <div class="content">
    	<div class="section group">
				<div class="col_1_of_3 span_1_of_3">
					...
					<p>The company which is being introduced is LPS Services, the company mainly is an E-commerave company, the LPS services is a industrial supply company which provide customer facility.The customer can order product from variety of option from one place and without hassle.the company is vendor of many companies.</p>
					<p>The main criteria though which company focuses:<p> 1. Trade: providing services to many comapnies</p>  <p>2. Services: providing a reparing help and maintaince</p> <p> 3. Manpower: provide a group  of worker to company for accomplishing any work</p></p>
				</div>
				<div class="col_1_of_3 span_1_of_3">
					<h3>Our History</h3>
				 <div class="history-desc">
					<div class="year"><p>2003 -</p></div>
